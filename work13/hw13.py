# import telebot, currency_button, currency_button2, currency_button3in
#
...
#         bot.send_message(message.from_user.id, 'Выберите валюту:', reply_markup=currency_button3in.choice_buttons())
...
#     if call.message:
#         if call.data == 'but1':
#             bot.send_message(call.message.chat.id, 'Сколько количество денего хотите обменять: ',
#                              reply_markup=currency_button2.cur_buttons())
#             bot.register_next_step_handler(call, euro)
#         elif call.data == 'but2':
#             bot.send_message(call.message.chat.id, 'Сколько количество денего хотите обменять: ',
#                              reply_markup=currency_button2.cur_buttons2())
#             bot.register_next_step_handler(call, dollar)
#         elif call.data == 'but3':
#             bot.send_message(call.message.chat.id, 'Сколько количество денего хотите обменять: ',
#                              reply_markup=currency_button2.cur_buttons3())
#             bot.register_next_step_handler(call, pound)
#
# @bot.message_handler(content_types=['text'])
# def euro(message):
